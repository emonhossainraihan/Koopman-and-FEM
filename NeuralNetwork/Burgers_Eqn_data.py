...
n_IC = 40  # Number of initial conditions (trajectories) in each file
n_train = 2  # Number of training files
...
# A 2-factor design with M samples where 
# the minimum distance between all samples has been maximized:
...
# Sampling of omega
max_omega = 10
# first success to occur on the k trials
# P(X=x) = (1-p)^(k-1) * p
...
# Validation Data
n_IC = 40  # Number of initial conditions
data_set = 'val_x'
